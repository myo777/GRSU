...
<meta name="viewport" content="width=device-width, initial-scale=1">
 ...
 <title>Global Rohingya Students Union </title>
  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav">
        <li <?php if(@$_GET['q']==0) echo'class="active"'; ?>><a href="dash.php?q=0">User<span class="sr-only">(current)</span></a></li>
        <li <?php if(@$_GET['q']==1) echo'class="active"'; ?>><a href="dash.php?q=1">Feedback</a></li>
        <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=3">Post Latest News</a></li>
            <li><a href="dash.php?q=4">Post Events</a></li>
            <li><a href="dash.php?q=5">Post Partners</a></li>
            <li><a href="dash.php?q=6">Post Project</a></li>
            <li><a href="dash.php?q=7">Post Policy</a></li>
			    </ul>
          <li class="dropdown <?php if(@$_GET['q']==4 || @$_GET['q']==5) echo'active"'; ?>">
          ...
          <ul class="dropdown-menu">
            <li><a href="dash.php?q=3">Latest News</a></li>
            <li><a href="dash.php?q=3">Public News</a></li>
            <li><a href="dash.php?q=4">Events</a></li>
            <li><a href="dash.php?q=5">Partners</a></li>
            <li><a href="dash.php?q=6">Project</a></li>
            <li><a href="dash.php?q=7">Policy</a></li>
			    </ul>
